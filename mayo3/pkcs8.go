...
// oid is a placeholder PKCS#8 algorithm OID for MAYO-3. NIST onramp
...
// MAYO-3 uses 7.
var oid = asn1.ObjectIdentifier{2, 16, 840, 1, 101, 3, 4, 3, 99, 7}
...
func (pkcs8Codec) ParsePKCS8(der []byte) (crypto.PrivateKey, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("mayo-3 private key decode: %w", err)
	}
	return s, nil
}
