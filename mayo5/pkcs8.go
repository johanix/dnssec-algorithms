...
// oid is a placeholder PKCS#8 algorithm OID for MAYO-5. NIST onramp
...
// MAYO-3 uses 7, MAYO-5 uses 8.
var oid = asn1.ObjectIdentifier{2, 16, 840, 1, 101, 3, 4, 3, 99, 8}
...
func (pkcs8Codec) ParsePKCS8(der []byte) (crypto.PrivateKey, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("mayo-5 private key decode: %w", err)
	}
	return s, nil
}
