...
// oid is a placeholder PKCS#8 algorithm OID for MAYO-1. NIST onramp
...
var oid = asn1.ObjectIdentifier{2, 16, 840, 1, 101, 3, 4, 3, 99, 2}
...
func (pkcs8Codec) ParsePKCS8(der []byte) (crypto.PrivateKey, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("mayo-1 private key decode: %w", err)
	}
	return s, nil
}
