...
// oid is a placeholder PKCS#8 algorithm OID for SNOVA-25_8_3. NIST
...
// (2.16.840.1.101.3.4.3.99.N). SNOVA-24_5_4 uses tail 3,
// SNOVA-37_17_2 uses 10, SNOVA-25_8_3 uses 11.
var oid = asn1.ObjectIdentifier{2, 16, 840, 1, 101, 3, 4, 3, 99, 11}
...
func (pkcs8Codec) ParsePKCS8(der []byte) (crypto.PrivateKey, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("snova-25_8_3 private key decode: %w", err)
	}
	return s, nil
}
