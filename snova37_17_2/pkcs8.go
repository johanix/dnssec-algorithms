...
// oid is a placeholder PKCS#8 algorithm OID for SNOVA-37_17_2. NIST
...
// SNOVA-37_17_2 uses 10.
var oid = asn1.ObjectIdentifier{2, 16, 840, 1, 101, 3, 4, 3, 99, 10}
...
func (pkcs8Codec) ParsePKCS8(der []byte) (crypto.PrivateKey, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("snova-37_17_2 private key decode: %w", err)
	}
	return s, nil
}
