...
// oid is a placeholder PKCS#8 algorithm OID for SNOVA-24_5_4. NIST
...
// (2.16.840.1.101.3.4.3.99.N).
var oid = asn1.ObjectIdentifier{2, 16, 840, 1, 101, 3, 4, 3, 99, 3}
...
func (pkcs8Codec) ParsePKCS8(der []byte) (crypto.PrivateKey, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("snova-24_5_4 private key decode: %w", err)
	}
	return s, nil
}
